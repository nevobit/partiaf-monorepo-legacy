  ...
  return (
    <View>
      ...
      <View style={{display: 'flex', flexDirection: 'row', paddingVertical: 10, alignItems: 'center', justifyContent: 'center'}}>
                ...
                <Image  source={{uri: user?.photo?.length <= 0? 'https://i.postimg.cc/0jMMGxbs/default.jpg' : user.photo }} style={{height: 110, width:110, borderRadius: 100, resizeMode: 'cover'}} />
            ...
            <View style={{display: 'flex', paddingTop: 10, alignItems: 'center', justifyContent:'center'}}>
                <Text style={{fontWeight: '700', color: '#111111', fontSize: 20, marginBottom: 5}}>{user.firstname} {user.lastname}</Text>
            ...
            <View style={{display: 'flex', flexDirection: 'row',justifyContent: 'center',  alignItems: 'center', marginTop: 30}}>
                ...
                <TouchableOpacity onPress={exit}  style={{ marginLeft: 10, backgroundColor: 'rgba(0,0,0,.005)', borderColor: 'rgba(0,0,0,.1)', borderWidth:1, width: 50, borderRadius: 5, height: 45, display: 'flex', alignItems: 'center', justifyContent: 'center'}} >
