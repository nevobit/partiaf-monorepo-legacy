...
const Payment = ({ route, navigation }: any) => {
  ...
  return (
    <View style={{ backgroundColor: "#fff", position: "relative" }}>
      ...
      <View style={{padding: 20, borderBottomWidth: 1, borderBottomColor: 'rgba(0,0,0,0.1)'}}>
        <Text style={{fontSize: 20}}> <Ionicons style={{fontSize: 22}} name="ios-wallet-outline" /> Saldo disponible </Text>
        <Text style={{fontSize: 28, fontWeight: '600'}} > {DivisaFormater(user.balance)}</Text>
      </View>
      <View style={{padding: 20, borderBottomWidth: 1, borderBottomColor: 'rgba(0,0,0,0.1)'}}>
        <Text style={{fontSize: 20}}> Total a pagar </Text>
        <Text style={{fontSize: 26, fontWeight: '600'}} > {DivisaFormater(240000)}</Text>
      </View>
      
      <View style={{padding: 20, borderBottomWidth: 1, borderBottomColor: 'rgba(0,0,0,0.1)'}}>
        <Text style={{fontSize: 18, fontWeight: '500', display: 'flex'}}> <Ionicons name="ios-clipboard-outline" style={{
            fontSize: 22
