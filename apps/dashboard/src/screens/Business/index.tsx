...
import { logoutAdmin } from "@/redux/states/admins/thunks";
...
const Bussiness = () => {
  ...
  const { loading: loadingStores, stores = [], successSignin } = useSelector(
      ...
      <div className={styles.modal_store}>
          <div className={styles.container_modal}>
            ...
            <div className={styles.content_modal}>
              <Field>
                <Input type="password" value={password} onChange={({target}) => setPassword(target.value)} placeholder="Ingrese la contrasena del negocio" />
              </Field>
              <Button onClick={signninStoreHandler} backgroundColor="#333" color="#f2f6fa">
                Entrar
              </Button>
              </div>
