...
interface UpdateWaiterModalProps {
  openModal: boolean;
  setOpenModal: Dispatch<SetStateAction<boolean>>;
  Waiter: PartialWaiter;
}

const UpdateWaiterModal = ({
  openModal,
  setOpenModal,
  Waiter,
}: UpdateWaiterModalProps) => {
  ...
  const submitUpdateHandler = async (
    ...
    try {
      dispatch(updateWaiter({ ...waiter, uuid: Waiter?.uuid }) as any);
    } catch (error) {
...
export default UpdateWaiterModal;
